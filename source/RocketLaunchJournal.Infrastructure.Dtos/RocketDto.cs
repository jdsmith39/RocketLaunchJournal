  ...
  public override bool Equals(object obj)
  {
    ...
    if (obj is RocketDto item)
    {
      return BlackPowderForApogee == item.BlackPowderForApogee && BlackPowderForMain == item.BlackPowderForMain
          && CenterOfGravity == item.CenterOfGravity && item.CenterOfPreassure == CenterOfPreassure 
          && item.TubeLengthForApogeeCharge == TubeLengthForApogeeCharge && item.TubeLengthForMainCharge == TubeLengthForMainCharge
