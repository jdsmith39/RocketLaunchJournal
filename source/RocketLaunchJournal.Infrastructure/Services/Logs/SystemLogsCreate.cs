...
public class SystemLogsCreate : BaseService
{
  ...
  public System.Threading.Tasks.Task SaveLog(LogTypeEnum logType, Exception exception, Guid? logGroupKey = null)
  {
    var userId = UserPermissionService.UserClaimModel.UserId <= 0 ? (int?)null : UserPermissionService.UserClaimModel.UserId;

    return SaveLog(userId, null, logType, exception, logGroupKey);
  }
  ...
  /// <param name="exception">event description is built based on the exception</param>
  /// <param name="logGroupKey">related log key (Guid)</param>
  public System.Threading.Tasks.Task SaveLog(int? userId, int? companyId, LogTypeEnum logType, Exception exception, Guid? logGroupKey = null)
  {
    ...
    return SaveLog(userId, null, eventDescription, logType, logGroupKey);
  }
  ...
  public System.Threading.Tasks.Task SaveLog(string eventDescription, LogTypeEnum logType, Guid? relatedLogsKey = null)
  {
    var userId = UserPermissionService.UserClaimModel.UserId <= 0 ? (int?)null : UserPermissionService.UserClaimModel.UserId;

    return SaveLog(userId, null, eventDescription, logType, relatedLogsKey);
  }
  ...
  /// <param name="logType">log type</param>
  /// <param name="logGroupKey">related log key (Guid)</param>
  public System.Threading.Tasks.Task SaveLog(int? userId, int? companyId, string eventDescription, LogTypeEnum logType, Guid? logGroupKey = null)
  {
  ...
  public System.Threading.Tasks.Task SaveLog(SystemLog dto)
  {
    LoggingDb.SystemLogs.Add(dto);
    return LoggingDb.SaveChangesAsync();
  }
}
